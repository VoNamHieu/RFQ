...
//   dist/src/storefront/index.html -> dist/storefront/index.html (served at /storefront/)
...
await mkdir(new URL('storefront/', dist), { recursive: true });
...
await rename(new URL('src/storefront/index.html', dist), new URL('storefront/index.html', dist));
...
console.log('postbuild: dist/index.html + dist/b2b/index.html + dist/storefront/index.html + dist/versions ready at', fileURLToPath(dist));
